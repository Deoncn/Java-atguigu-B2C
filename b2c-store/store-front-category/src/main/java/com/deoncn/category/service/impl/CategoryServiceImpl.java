package com.deoncn.category.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.deoncn.category.mapper.CategoryMapper;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public R adminSave(Category category) {
        ...
        log.info("CategoryServiceImpl.adminSave 业务结束，结果：{}", insert);
    ...
    public R adminRemove(Integer categoryId) {
        ...
        log.info("CategoryServiceImpl.adminRemove 业务结束，结果：{}", i);
    ...
    public R adminUpdate(Category category) {
        ...
        log.info("CategoryServiceImpl.adminUpdate 业务结束，结果：{}", i);
