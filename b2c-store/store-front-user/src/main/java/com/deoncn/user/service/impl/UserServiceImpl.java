package com.deoncn.user.service.impl;
...
import com.deoncn.user.mapper.UserMapper;
...
public class UserServiceImpl implements UserService {
     ...
     * 登录业务
     * 1.密码的加密和加盐处理
     * 2.根据账号和密码进行数据库查询，返回一个完整的数据库对象 user对象
     * 3.判断返回结果
     *
     ...
     * 修改用户信息
     *      1.账号和ID 不会修改
     *      2.密码需要进行数据库判断 是不是原来的密码，如果是，不用处理直接修改
     *      3.如果是新密码 加密后更新
     *      4.修改用户信息
     * @param user
     * @return
    ...
    public R update(User user) {
        ...
        log.info("UserServiceImpl.update 业务结束，结果：{}",i);
